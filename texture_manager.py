...
class Texture_manager:
    def __init__(self, texture_width, texture_height, max_textures):
        ...
        glBindTexture(gl.GL_TEXTURE_2D_ARRAY, self.texture_array)

        glTexParameteri(gl.GL_TEXTURE_2D_ARRAY, gl.GL_TEXTURE_MAG_FILTER, gl.GL_NEAREST)
    ...
    def generate_mipmaps(self):
        glBindTexture(gl.GL_TEXTURE_2D_ARRAY, self.texture_array)
        glGenerateMipmap(gl.GL_TEXTURE_2D_ARRAY)
